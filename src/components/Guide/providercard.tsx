...
const ProviderCard = ({
  ...
  return (
    <div className="bg-[#FFFFFF0D] rounded-lg border border-[#FFFFFF33] text-white p-6 w-full max-w-sm">

      <div className="mb-4 -mx-6 -mt-6">
        <div className="bg-linear-to-r from-[#00B8DB33] to-[#2B7FFF33] px-6 py-5 rounded-t-lg">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h3 className={`text-lg font-semibold ${FONTSIZE[20]}`} style={{fontWeight:WEIGHT.seven,color:COLORS.primary_white}}>{name}</h3>
              ...
              <div className="flex items-center gap-2 text-sm mt-1">
                <img
                  ...
                  className="w-4 h-4"
                />
                <span className={`text-cyan-400 ${FONTSIZE[14]}`} style={{fontWeight:WEIGHT.seven,color:COLORS.para}}>{service}</span>
              </div>

              <p className={`text-slate-300 text-xs mt-1 ${FONTSIZE[12]}`} style={{fontWeight:WEIGHT.four,color:COLORS.grey}}>
                ID: {serviceId}
              </p>
...
>
  ...
  Phone Number
        ...
        <p className={`font-medium ${FONTSIZE[16]}`} style={{fontWeight:WEIGHT.seven,color:COLORS.primary_white}}>{phone}</p>
...
>
  ...
  Email Address
        ...
        <p className={`font-medium break-all ${FONTSIZE[14]}`} style={{fontWeight:WEIGHT.seven,color:COLORS.primary_white}}>{email}</p>
      </div>

      <div className="grid grid-cols-2 gap-4 border-t border-slate-700 pt-4">
        <div>
          <p className={`text-slate-400 text-xs ${FONTSIZE[12]}`} style={{fontWeight:WEIGHT.four,color:COLORS.grey}}>Experience</p>
<p
...
>
  ...
  {experience}
        ...
        <div>
          <p className={`text-slate-400 text-xs ${FONTSIZE[12]}`} style={{fontWeight:WEIGHT.four,color:COLORS.grey}}>Join Date</p>
<p
  className={`flex items-center gap-2 ${FONTSIZE[14]}`}
  style={{ fontWeight: WEIGHT.seven, color: COLORS.primary_white }}
>
  ...
  {joinDate}
      ...
      <div className="border-t border-slate-700 pt-4 mt-4">
        <p className={`text-slate-400 text-xs ${FONTSIZE[12]}`} style={{fontWeight:WEIGHT.four,color:COLORS.grey}}>Specialization</p>
<p
...
>
  ...
  {specialization}
      ...
      <div className="grid grid-cols-2 gap-3 mt-4 pt-4 border-t border-[#FFFFFF22]">
